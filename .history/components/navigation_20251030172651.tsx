    ...
    <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> 
        <div className="flex justify-between items-center h-16 ">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity max-h-[100px] max-w-[100px]">
           <Image src="/The Gold Lab logo.png" height={100} width={100} alt="The Gold Lab" className="h-[100px] w-[100px]"/>
